Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/andrewBatutin/pico.git", :tag => "0.5.0" }

  s.source_files  =  "pico/PicoSource/Core/**/*.{h,m}", "pico/PicoSource/SOAP/**/*.{h,m}", "pico/PicoSource/WebService/**/*.{h,m}" ,"pico/PicoSource/Vendor/XMLWriter/**/*.{h,m}" 
  s.libraries = 'xml2'
